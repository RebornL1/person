...
| 日期 | 更新内容 |
|------|----------|
| 2026-04-23 | 重构表格列结构：适配新列名（接单数工作量、参会情况、未闭环oncall接单数、昨日新增工单数等） |
| 2026-04-23 | 新增文本字段特殊展示：参会情况标签badge、案例/提单记录链接形式、风险问题单独高亮 |
| 2026-04-23 | 优化自定义图表展示：多日汇总数据时汇总图和平均图并排显示 |
